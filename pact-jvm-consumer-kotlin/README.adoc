...
* short and concise (no boilerplate)
...
.ConsumerPactBuilder
----
include::src/test/kotlin/au/com/dius/pact/consumer/kotlin/dsl/examples/ConsumerPactBuilderExample.kt[lines=7..43]
----
...
.kPact
----
include::src/test/kotlin/au/com/dius/pact/consumer/kotlin/dsl/examples/Junit5Example.kt[lines=14..26]
----

[source,java,indent=0,role="secondary"]
.ConsumerPactBuilder
----
include::src/test/kotlin/au/com/dius/pact/consumer/kotlin/dsl/examples/Junit5Example.kt[lines=30..41]
----
